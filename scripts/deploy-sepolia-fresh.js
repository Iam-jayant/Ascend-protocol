...
async function main() {
  console.log("🚀 Starting FRESH Ascend Protocol deployment to Sepolia testnet...\n");
  ...
  try {
    ...
    fs.writeFileSync('deployment-sepolia-fresh.json', JSON.stringify(deploymentInfo, null, 2));
    console.log("\n💾 Deployment info saved to deployment-sepolia-fresh.json");
